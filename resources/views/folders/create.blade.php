                ...
                <form>
                    <div class="card-body" style="padding: 1rem 1rem 0;">
                        ...
                        <div class="form-group">
                            ...
                            <button class="file-upload__button" type="button" style="-webkit-appearance: none; color: #fff; background-color: #007bff; border-color: #007bff; box-shadow: none; border-radius: 4px; outline: none; padding: 0.375rem 0.75rem; margin-right: 7px; font-size: 1em; cursor: pointer; font-weight: 400;">Wybierz plik(i)</button>
