                ...
                <form action="{{ route('folders.update', $folder->id) }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="folder_name" name="folder_name" value="{{ $folder->name }}">
                        </div>
                        <div class="form-group">
                            <label for="form-control">Opis</label>
                            <textarea class="form-control" rows="3" name="folder_description">{{ $folder->description }}</textarea>
                        </div>
                        <div class="form-group">
